...
export default {
    ...
    data(){
        return {
             ...
             */
            BasicList:[
                {type:'input',name:'文本输入框',inpType:'text',icon:require('@/assets/img/input.png')},
                {type:'input',name:'数字输入框',inpType:'tel',icon:require('@/assets/img/InpNum.png'),},
            ...
            connectList:[
                {type:'input',name:'姓名',inpType:'text',icon:require('@/assets/img/name.png'),prefix:'ios-contact',required:true,},
                {type:'input',name:'手机',inpType:'tel',icon:require('@/assets/img/phone.png'),prefix:'logo-whatsapp',required:true,},
                {type:'input',name:'公司',inpType:'text',icon:require('@/assets/img/phone.png'),prefix:'ios-podium'},
                {type:'input',name:'部门',inpType:'text',icon:require('@/assets/img/phone.png'),prefix:'ios-people'},
                {type:'input',name:'职位',inpType:'text',icon:require('@/assets/img/phone.png'),prefix:'ios-man'},
                {type:'input',name:'地址',inpType:'text',icon:require('@/assets/img/phone.png'),prefix:'ios-pin'},
                {type:'Select',name:'性别',options:[{key:'男',value:'男'},{key:'女',value:'女'}],icon:require('@/assets/img/phone.png'),prefix:"ios-transgender"},
                {type:'input',name:"微信号",inpType:'text',icon:require('@/assets/img/phone.png'),prefix:'ios-text'},
            ]
        }
    },
    methods:{
